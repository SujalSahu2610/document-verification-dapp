...
// ✅ Pinata Legacy API Keys (safe for local testing)
const PINATA_API_KEY = "31cc70b6371fb401f304";
const PINATA_SECRET_API_KEY = "9899f9e6ab549d7e9c7ad9cf6200304d8b3d606d71abe9d4948b76046a4238c4";

window.CONTRACT = {
  address: "0x992d53c79AD09Da4e85Eae04148068837fcB6491",
...
async function connect() {
  if (window.ethereum) {
    try {
      ...
      console.log("✅ Connected:", window.userAddress);
      ...
      // ✅ Do NOT reload instantly (breaks network info)
      setTimeout(() => {
...
async function uploadFileToIpfs() {
  ...
  try {
    ...
    console.log("🔍 RAW IPFS RESPONSE:", text);

    // ✅ Extract CID manually
    const match = text.match(/"Hash":"([^"]+)"/);

    if (!match) {
      console.error("❌ Could not parse CID");
      return null;
    }
    ...
    console.error("❌ Local IPFS Upload Error:", err);
    alert("Local IPFS upload failed. Make sure IPFS daemon is running on :5001");
    return null;
  }
}
...
async function get_ChainID() {
  ...
  switch (a) {
    ...
    case 137:
      ...
      break;
    case 3:
      window.chainID = "Ropsten Testnet";
      break;
    case 4:
      window.chainID = "Rinkeby Testnet";
      break;
    case 5:
      window.chainID = "Goerli Testnet";
      break;
    case 42:
      window.chainID = "Kovan Testnet";
      break;
